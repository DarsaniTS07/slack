...
const Quotation = () => {
  return (
    <Box>
      <Typography sx={{ marginTop: "15px", fontSize: "18px", fontWeight: "bold",color:"#4E5A6B" }}>Quotation Summary</Typography>
      <Box
        border="1px solid"
        height="26.6rem"
        color="#F5F7FA"
          ...
          <Table aria-label="quotation-table">
            <TableHead >
              <TableRow>
                ...
                <TableCell align="left"><Typography sx={{ fontWeight: '500' , fontSize:'13px', color:"#98A0AC"}}>QTY</Typography></TableCell>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell align="left" sx={{ padding: "10px 18px", color:"#4E5A6B" }}>10%</TableCell>
